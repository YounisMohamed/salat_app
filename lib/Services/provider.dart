...
class LanguageProvider with ChangeNotifier {
  ...
  final Map<String, String> toEnglish = {
    ...
    "initConfigurations": "Initial Configurations",
    "changeTheme": "Change Theme",
    "clickHereToChangeThemeOfApp": "Click here to change theme of app",
    ...
    "appPermissionsRequired": "App Permissions Required",
    ...
    "notiPermissionDescription": "To notify you about the prayer times.",
  ...
  Map<String, String> toArabic = {
    ...
    "initConfigurations": "الإعدادات الأولية",
    "changeTheme": "تغيير الثيم",
    "clickHereToChangeThemeOfApp": "اضغط هنا لتغيير ثيم التطبيق",
    "chooseYourTheme": "اختر الثيم الخاصة بك",
    "Default": "افتراضي",
    "Purple": "أرجواني",
    "Brown": "بني",
    "Blue": "أزرق",
    ...
    "Indigo": "نيلي",
    "continue": "استمر",
    "clickHereToProceed": "اضغط هنا للمتابعة",
    "appPermissionsRequired": "الأذونات المطلوبة للتطبيق",
    "permissionDescription": "لتزويدك بأفضل تجربة، نحتاج إلى الأذونات التالية",
    "locationPermission": "إذن الموقع",
    "locationPermissionDescription":
        "للوصول إلى موقعك للحصول على أوقات صلاة دقيقة.",
    "notiPermission": "إذن الإشعارات",
    "notiPermissionDescription": "لإعلامك بأوقات الصلاة.",
  ...
  final Map<String, String> toSpanish = {
    ...
    "initConfigurations": "Configuraciones Iniciales",
    "changeTheme": "Cambiar Tema",
    "clickHereToChangeThemeOfApp":
        "Haz clic aquí para cambiar el tema de la aplicación",
    ...
    "Indigo": "Índigo",
    "continue": "Continuar",
    "clickHereToProceed": "Haz clic aquí para continuar",
    "appPermissionsRequired": "Permisos de la Aplicación Requeridos",
    "permissionDescription":
        "Para brindarte la mejor experiencia, necesitamos los siguientes permisos",
    "locationPermission": "Permiso de Ubicación",
    "locationPermissionDescription":
        "Para acceder a tu ubicación para horarios de oración precisos.",
    "notiPermission": "Permiso de Notificaciones",
    "notiPermissionDescription":
        "Para notificarte sobre los horarios de oración.",
